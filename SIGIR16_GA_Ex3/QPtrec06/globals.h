...
//	const double percent_of_index = 0.50;	
	const uint Query_Budget_TopLayer = 1000; //useless
	const uint Query_Budget_TermPair = 3000; //useless
	...
	const std::string Candidates_Pool("/home/qw376/Data_for_SIGIR2016/Greedy_Candidates/Exp6_5k_3k");//Candidates index
