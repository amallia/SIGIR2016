...
namespace CONSTS {
	...
	//######dodo########
	const std::string ikQuery("/home/qw376/million9_query_trace/million09_testing_actualqueries_no_colon_withqid"); //1k_trec05; //1000query
	...
	const std::string fResultLog("/home/qw376/Data_for_SIGIR2016/And_Candidates/And_500");
	//######dodo########
